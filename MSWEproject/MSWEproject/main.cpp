...
int main(void)
{
	...
	//HANDLE WINAPI buffer = CreateConsoleScreenBuffer(GENERIC_READ, 0, secAttr, CONSOLE_TEXTMODE_BUFFER, NULL);
	...
	SetConsoleCursorPosition(hStdout, *cordinate);
